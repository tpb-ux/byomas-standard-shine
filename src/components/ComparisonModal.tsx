...
import { Scale, ExternalLink, Download, Image, FileText, Loader2, Table, BarChart3 } from "lucide-react";
...
const ComparisonModal = ({ open, onOpenChange, empresasSelecionadas }: ComparisonModalProps) => {
  ...
  const empresasParaGrafico = casos.map(caso => ({
        ...
        <Tabs value={activeTab} onValueChange={setActiveTab} className="w-full">
          ...
          <TabsContent value="graficos" className="space-y-6">
            ...
            <SustainabilityEvolutionChart 
              empresas={empresasParaGrafico}
              titulo="Evolução Comparativa (2018-2023)"
            />
            
            {/* Gráfico Radar */}
            <SustainabilityRadarChart 
              casos={casos}
              titulo="Análise Multi-dimensional"
            />
          </TabsContent>
        </Tabs>
