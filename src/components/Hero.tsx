        ...
        <div className="container mx-auto px-6">
          <div className="max-w-4xl">
            ...
            <h1 className="mb-8 text-4xl font-bold leading-tight md:text-5xl lg:text-6xl">
              <span className="text-foreground">Libere o poder da </span>
            ...
            <div className="flex flex-wrap gap-4">
              <Link to="/contato">
                <Button 
                  variant="outline" 
                  size="lg" 
                  className="border-foreground text-foreground hover:bg-foreground hover:text-background font-medium px-8"
                >
                  CONECTE-SE CONOSCO
